                    ...
                    <>
                        {featuredBlog ? (
                            <section className="mb-20">
                                ...
                                >
                                    <Link href={`/blog/${featuredBlog.slug}`} className="lg:col-span-8 relative overflow-hidden rounded-sm">
                                    ...
                                    <div className="lg:col-span-4 flex flex-col justify-center h-full pt-2">
                                        ...
                                        <div className="mt-auto flex items-center justify-between border-t border-gray-200 pt-4 w-full">
                                            ...
                                            <Link
                                                ...
                                                className="text-[#E21339] font-sans text-xs font-bold uppercase flex items-center gap-1 group-hover:gap-2 transition-all"
                                            >
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-x-12 gap-y-16 border-t border-black pt-16">
                            {remainingBlogs.map((blog, idx) => (
                                ...
                                >
                                    <Link href={`/blog/${blog.slug}`} className="relative aspect-[3/2] mb-6 overflow-hidden bg-gray-100 rounded-sm">
                                        {blog.coverUrl ? (
                                            <img
                                                src={blog.coverUrl}
                                                alt={blog.title}
...
export const getServerSideProps: GetServerSideProps<Props> = async ({ res }) => {
    ...
    try {
        ...
        console.error("Failed to fetch blog posts for /blog:", error);
        return {
            props: {
                blogs: [],
            },
