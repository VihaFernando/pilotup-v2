          ...
          <div className="z-30 flex shrink-0 items-center justify-between border-b border-slate-200/90 bg-white/90 px-4 py-2.5 backdrop-blur-md lg:hidden dark:border-[#3d3d3d] dark:bg-[#2b2b2b]/90">
            <Link href="/" className="flex items-center gap-2">
              <img
                ...
                alt="PilotUP"
                className="h-6 w-auto max-w-[120px] object-contain object-left dark:hidden sm:h-7 sm:max-w-[140px]"
              />
              <img
                src="/brand-assets/png/full-logo-dark.png"
                alt=""
                className="hidden h-6 w-auto max-w-[120px] object-contain object-left dark:block sm:h-7 sm:max-w-[140px]"
                aria-hidden
              />
